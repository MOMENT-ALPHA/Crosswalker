...
<template>
    <div class="pointer-events-none fixed top-4 right-4 z-[60] flex w-80 flex-col gap-2">
        ...
        >
            <div v-for="toast in ui.toasts" :key="toast.id" class="pointer-events-auto flex items-start gap-2.5 rounded-lg border px-3.5 py-3 shadow-lg" :class="toneClass[toast.type]">
                <AppIcon :name="iconName[toast.type]" :size="16" class="mt-0.5" />
