...
const toneClass: Record<Tone, { box: string; icon: string; name: string }> = {
    ...
    warning: { box: "border-amber-200 bg-amber-50 text-amber-900", icon: "text-amber-600", name: "alert" },
    danger: { box: "border-rose-200 bg-rose-50 text-rose-900", icon: "text-rose-600", name: "alert" },
};
